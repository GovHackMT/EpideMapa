...
public class TelaInfoTuberculose extends AppCompatActivity {

        //Tela com informações sobre a tuberculose
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapasaude.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(TelaInfoTuberculose.this, MapaPostosDeSaude.class);
                startActivity(it);
            }
        });
